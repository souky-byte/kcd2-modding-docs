...
> Source: [https://youtrack.warhorsestudios.cz/articles/KM-A-55](https://youtrack.warhorsestudios.cz/articles/KM-A-55)
...
* Tools/enviro/ - plugin for 3ds max, see KM-A-42
* Tools/GeneratedDatabase/ - a dll with structure of the game database. It is used by several other tools
* Tools/maya/ - plugin for maya, see KM-A-66
* Tools/modding/3dsmax/ - further files for 3ds max plugin, see KM-A-42
* Tools/modding/docs/ - documentation for all Lua bindings
* Tools/modding/excelAddin/ - an addon for MS Excel that allows for convenient editing of some game tables, see KM-A-86
* Tools/modding/Maya/ - further files for maya plugin, see KM-A-66
* Tools/modding/USER_ShaderCacheGen/ - shader lists needed to generate shader cache, see KM-A-82
...
* Tools/ShaderCacheGen/ - tool for generating shader cache, see KM-A-82
* Tools/Skald/ - editor for quest scripts and dialogues, see KM-A-18
* Tools/Smid/ - editor for NPC clothing, body parts, inventories, see KM-A-14
* Tools/SteamWorkshopUploader/ - tool for uploading mods to steam workshop, see KM-A-85
* Tools/TraceServer/ - tool for analyzing live game log, started automatically by development game or editor
* Tools/WH_ArtDotNetTools/ - further files for 3dsmax plugin, see KM-A-42
