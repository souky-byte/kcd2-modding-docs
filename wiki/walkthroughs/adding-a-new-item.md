...
> Source: [https://youtrack.warhorsestudios.cz/articles/KM-A-17](https://youtrack.warhorsestudios.cz/articles/KM-A-17)

KCD2 stores all the database entries in .XML files found in `Data/libs/Tables/...` or in `Tables.pak/Tables/...` - the summary and more information about them can be found at KM-A-12.
